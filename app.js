...
// alert("Already displayed:", pokemon.name);
    ...
    pokeBox.innerHTML = `
      <h2 class="pokeTitle"><a href="https://www.pokemon.com/fi/pokedex/${pokemon.name}">${pokemon.name}</a></h2>
...
async function getAllPokemonData() {
  let getAllPokemonRequest = "https://pokeapi.co/api/v2/pokemon/?offset=0&limit=1281";

  try {
    const response = await fetch(getAllPokemonRequest);
